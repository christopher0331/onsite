    ...
    <section className="relative py-20 sm:py-32 bg-warm-gray overflow-hidden">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          >
            <div className="flex flex-col h-full overflow-hidden rounded-3xl shadow-[0_24px_80px_rgba(0,0,0,0.2)]">
              <Link href={listings[0].href} className="group block flex-1">
                <div className="relative h-full min-h-[400px] lg:min-h-0 overflow-hidden">
                  <Image
          ...
          {listings.slice(1).map((listing, i) => (
            ...
            >
              <div className="flex flex-col overflow-hidden rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.18)]">

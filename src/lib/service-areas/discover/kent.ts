...
export const kentDiscover: ServiceAreaDiscover = {
  slug: "kent",
  ...
  localLivingMarkdown: [
    "Kent spans [East Hill](/service-areas/kent/east-hill), [Downtown Kent](/service-areas/kent/downtown-kent), [Panther Lake](/service-areas/kent/panther-lake), [West Hill](/service-areas/kent/west-hill), and [Lake Meridian](/service-areas/kent/lake-meridian) across ZIPs 98030, 98031, 98032, and 98042 — valley-floor access pockets next to hillside residential streets. Buyers comparing [Kent homes for sale](/listings?city=Kent&state=WA) often cross-shop [Federal Way](/service-areas/federal-way), [Auburn](/service-areas/auburn), and [Tacoma](/service-areas/tacoma) while sorting by floodplain diligence on the valley floor, ADU feasibility on East Hill lots, and [Kent School District](https://www.kent.k12.wa.us/) boundaries. Everyday life ties to [City of Kent](https://www.kentwa.gov/) services, [Puget Sound Energy](https://www.pse.com/), and [King County Library System](https://kcls.org/) branches downtown and on the hill.",
    "OnSite Real Estate Group positions Kent listings against the exact competing submarket — East Hill comps stay with East Hill, [Lake Meridian](/service-areas/kent/lake-meridian) shoreline streets get their own lake-adjacent comps, valley parcels get flood and lender documentation early, and [Panther Lake](/service-areas/kent/panther-lake) or [West Hill](/service-areas/kent/west-hill) homes are framed for their own commute and lot patterns. Parcel detail from the [King County Assessor](https://kingcounty.gov/en/dept/assessor) and permit context from city Planning keep pricing and disclosures grounded in how each pocket actually lives.",
  ],
};

...
export const dashPointDiscover: ServiceAreaDiscover = {
  slug: "dash-point",
  ...
  attractions: [
    {
      ...
      description:
        "Dash Point State Park is the neighborhood's namesake open-space anchor — beach access, trails, camping, and Sound-edge recreation that buyers cite when comparing this pocket to inland Twin Lakes, West Campus, or Lakota.",
    },
    {
      name: "Dash Point Beach & Pier Approaches",
      url: "https://www.google.com/maps/place/Dash+Point,+Federal+Way,+WA",
      description:
        "Beach and pier approaches organize weekend routines for Dash Point households — concrete shoreline access that shows up on buyer tours without requiring a long drive to another Sound pocket.",
    },
    {
      name: "Puget Sound Marine Bluffs",
    ...
    },
    {
      ...
      description:
        "Dash Point addresses feed Federal Way Public Schools pathways, but elementary and secondary assignments still need address-level confirmation — ZIP alone is not a school map.",
    },
    {
      name: "King County Library System — Federal Way",
      url: "https://kcls.org/",
      description:
        "KCLS Federal Way branches support everyday reading, study space, and family programs for Dash Point households balancing school and commute routines.",
    },
    {
      name: "Dash Point Rd & SW 320th St",
      url: "https://www.google.com/maps/place/Dash+Point+Rd,+Federal+Way,+WA",
      description:
        "Dash Point Road, SW 320th, SW 312th, and 21st Avenue SW organize how Dash Point residential streets connect to I-5, City Center shopping, Lakota, Twin Lakes, and Sound-edge approaches used for showings and commute planning.",
    },
  ],
  localLivingMarkdown: [

          ...
          <div className="mx-auto max-w-[1440px] px-6 lg:px-12">
            ...
            >
              ...
              <div className="relative z-10 mt-auto p-10 lg:max-w-3xl">
                ...
                <p className="mb-3 text-[11px] uppercase tracking-[0.25em] text-white/80">Market Trends</p>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-between bg-white p-6">
        <div>
          <p className="mb-2 text-[10px] uppercase tracking-[0.25em] text-charcoal/65">Market Trends</p>

...
**Live spokes today:** South Hill + Downtown + Clark's Creek + Rodesco + Shawnee Ridge + Gem Heights + Summit + Tacoma North End + Tacoma Stadium District + Tacoma West Slope  
**Canvas:** `puyallup-competitive-gap.canvas.tsx`  
**Last updated:** 2026-09-04  
**Content depth (2026-09-04):** Discover + long-form articles cover all 13 hubs and prior spokes; next Tacoma spokes: Proctor District (open PR #12), South Tacoma — then Federal Way / Kent / Seattle directory stubs.

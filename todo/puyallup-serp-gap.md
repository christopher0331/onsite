...
**Live spokes today:** South Hill + Downtown + Clark's Creek + Rodesco + Shawnee Ridge + Gem Heights + Summit + Tacoma North End + Tacoma Proctor District  
**Canvas:** `puyallup-competitive-gap.canvas.tsx`  
**Last updated:** 2026-09-01  
**Content depth (2026-09-01):** Discover + long-form articles cover all 13 hubs and prior spokes; next Tacoma spokes: Stadium District, West Slope, South Tacoma — then Federal Way / Kent / Seattle directory stubs.
